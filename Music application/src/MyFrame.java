...
public class MyFrame extends JFrame implements ActionListener
{
	...
	{	
		...
		file[0] = new File("Lie to me - 5SOS.wav");
		file[1] = new File("Malibu - Miley Cyrus.wav");
		file[2] = new File("She looks so perfect - 5SOS.wav");
		file[3] = new File("Somebody to you - The Vamps ft. Demi Lovato.wav");
		file[4] = new File("Teenage dream - Katy Perry.wav");
		file[5] = new File("The one that got away - Katy Perry.wav");
		file[6] = new File("Thinking of you - Katy Perry.wav");
		file[7] = new File("Wake up - The Vamps.wav");
